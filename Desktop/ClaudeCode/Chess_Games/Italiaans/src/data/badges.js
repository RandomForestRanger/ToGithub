...
export const BADGES = [
  ...
  // ── Medium kentekens — struktuur ───────────────────────────────────────
  {
    ...
    emoji: '🔺',
    wenWenrig: "Speel Bc4 (biskop na c4), Nf3 (ruiter na f3) en d3 (pion na d3). Hierdie drie skuiwe vorm 'n driehoek: die biskop beoog f7, die ruiter beheer die sentrum, en d3 hou die sentrum stewiger — die Italianer se fondament!",
    beskrywing: "Laag 1 voltooi! Bc4 + Nf3 + d3 vorm die Italiaanse driehoek — biskop beoog f7, ruiter beheer die sentrum, d3 hou alles stewig vas.",
    moeilikheid: 'medium',
    when: 'move',
  ...
  },
  {
    ...
    emoji: '🗺️',
    wenWenrig: "Speel c3 (pion na c3) en bring jou ruiter na a3 of c3. c3 berei die groot d4-sentrum-skuif voor. Die ruiter op a3 of c3 sal later die d4-pion ondersteun. Jy kies die pad — maar kies met 'n plan!",
    beskrywing: "Laag 2 bereik! c3 berei die d4-breuk voor — jou ruiter op a3 of c3 staan reg om die sentrum te ondersteun.",
    moeilikheid: 'medium',
    when: 'move',
  ...
  },
  {
    ...
    italiaans: 'Il Centro',
    emoji: '💥',
    wenWenrig: "Nadat jy c3 gespeel het, stoot d4! Hierdie is die Italianer se groot idee: gebruik die c3-pion om die d4-skuif te ondersteun en die middelbord oop te breek. Swart se e5-pion word uitgedaag — jy neem beheer van die middel van die bord!",
    beskrywing: "Die middelbord is joune! c3 het die weg gebaan; d4 het Swart se e5 uitgedaag en die sentrum oopgebreek — presies die Italianer se plan.",
    moeilikheid: 'medium',
    when: 'move',
